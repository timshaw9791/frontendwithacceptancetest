    ...
    export default {
        ...
        methods:{
            getDehumidification(){
                this.$ajax({
                    method:'post',
                    url:'http://62.147.39.30:8010/warehouse/environment/dehumidifierStatus',
                }).then((res)=>{
            ...
            dehumidificationControl(data){
                this.$ajax({
                    method:'post',
                    url:'http://62.147.39.30:8010/warehouse/environment/dehumidifierSwitch?status='+data,
                }).then((res)=>{
                    if (res.data.msg=='成功') {
            ...
            submissionThreshold(){
                this.$ajax({
                    method:'post',
                    url:'http://62.147.39.30:8010/warehouse/environment/humidityThresholdSet',
            ...
            getThreshold(){
                this.$ajax({
                    method:'post',
                    url:'http://62.147.39.30:8010/warehouse/environment/humidityThreshold',
                }).then((res)=>{

    ...
    export default {
        ...
        methods:{
            getChargingStationtList(){
              this.ajax('http://10.128.4.127:8080/warehouse/environment/getChargeCount','',(data)=>{
            ...
            getChargingStationtNumber(number){
                this.ajax('http://10.128.4.127:8080/warehouse/environment/chargeQuery',{number:Number(number)},(data)=>{
                ...
                //     },0)
                // }, true)
               /* this.ajax('http://10.128.4.127:8080/warehouse/environment/chargeQuery',params,(data)=>{

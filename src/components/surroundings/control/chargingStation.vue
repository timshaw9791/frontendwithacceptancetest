    ...
    export default {
        ...
        methods:{
            getChargingStationtList(){
              this.ajax('http://192.168.50.15:8080/warehouse/environment/getChargeCount','',(data)=>{
            ...
            getChargingStationtNumber(number){
                this.ajax('http://192.168.50.15:8080/warehouse/environment/chargeQuery',{number:Number(number)},(data)=>{

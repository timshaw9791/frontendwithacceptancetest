    ...
    export default {
        ...
        methods:{
            ...
            controlAir(data){
                this.$ajax({
                    method:'post',
                    url:'http://192.168.125.117:8080/warehouse/environment/airConditionerSwitch',
                    params:{status:data}
                }).then((res)=>{
            ...
            submissionThreshold(){
                this.$ajax({
                    method:'post',
                    url:'http://192.168.125.117:8080/warehouse/environment/temperatureThresholdSet',
            ...
            getThreshold(){
                this.$ajax({
                    method:'post',
                    url:'http://192.168.125.117:8080/warehouse/environment/temperatureThreshold',
                }).then((res)=>{
                ...
                this.$ajax({
                    method:'post',
                    url:'http://192.168.125.117:8080/warehouse/environment/airConditionerStatus',
                }).then((res)=>{

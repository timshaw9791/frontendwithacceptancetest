    ...
    export default {
        ...
        methods:{
            ...
            controlAir(data){
                this.$ajax({
                    method:'post',
                    url:'http://62.147.39.30:8010/warehouse/environment/airConditionerSwitch',
                    params:{status:data}
                }).then((res)=>{
            ...
            submissionThreshold(){
                this.$ajax({
                    method:'post',
                    url:'http://62.147.39.30:8010/warehouse/environment/temperatureThresholdSet',
            ...
            getThreshold(){
                this.$ajax({
                    method:'post',
                    url:'http://62.147.39.30:8010/warehouse/environment/temperatureThreshold',
                }).then((res)=>{
                ...
                this.$ajax({
                    method:'post',
                    url:'http://62.147.39.30:8010/warehouse/environment/airConditionerStatus',
                }).then((res)=>{

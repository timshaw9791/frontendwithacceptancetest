    ...
    export default {
        ...
        methods:{
            getLightInfo(){
                this.$ajax({
                    method:'post',
                    url:'http://10.128.4.127:8080/warehouse/environment/getLightInfo',
                }).then((res)=>{
            ...
            getLightQuery(list){
                this.$ajax({
                    method:'post',
                    url:'http://10.128.4.127:8080/warehouse/environment/lightQuery',
                }).then((res)=>{
            ...
            changeAll(data){
                ...
                this.$ajax({
                    method:'post',
                    url:'http://10.128.4.127:8080/warehouse/environment/lightSwitch',
                    params:{status:data}
                }).then((res)=>{

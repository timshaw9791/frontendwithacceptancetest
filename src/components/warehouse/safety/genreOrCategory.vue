<template>
    <div>
        <serviceDialog :title="title" ref="addGenreServiceDialog" width="3.3021rem"
                       :button="false">
            <div class="add_genre_box" >
                <div class="add_genre_body" v-if="type!=='unallocated'">
                    ...
                    <div class="add_genre_item" :style="title==='修改小类'?'margin-top: 0.1042rem':'margin-top:0.521875rem'">
                        <label style="width: 0.56875rem" v-text="type==='tree'?'装备大类:':'装备小类:'"></label>
                ...
                <div class="add_genre_foot">
                    ...
                    <el-button style="margin-left: 0.1042rem" :disabled="disabled" type="primary" @click="dialogConfirm" data-test="button">确 定</el-button>
                </div>
            </div>
        </serviceDialog>
    </div>
...
<script>
    ...
    export default {
        ...
        created(){
          console.log('this.genreData.categorySet',this.genreData.categorySet)
        },
        props:{
            title:{
                type:String
        ...
        methods: {
            show() {
                this.$refs.addGenreServiceDialog.show()
            },
            cancelDb() {
                this.$refs.addGenreServiceDialog.cancel();
            },
            changeGenre(data) {

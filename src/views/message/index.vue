...
<div>
    <div class="msgContents">
        <div>
            <div class="top">
                <tb-select :options="options" indexDefault="全部" style="margin-left: 1vw" @selected="selected"></tb-select>
...
import {
    formRulesMixin
} from 'field/common/mixinComponent';
import tabs from 'components/base/tabs/index'
import {
    transformMixin
} from 'common/js/transformMixin'
    ...
    data() {
        return {
            ...
            options: [{
                ...
                {
                    label: '保养',
                    value: 'MAINTAIN_REMIND'
                },
                {
                    label: '未归还',
                    value: 'LONG_TIME_NOT_RETURN'
                },
                {
                    label: '过保',
                    value: 'PERIOD_EXCEED_SHELF_LIFE'
                },
                {
                    label: '标准库存',
                    value: 'SAFE_SOCK_REMIND'
                },
            ],
            qfilter: {},
        }

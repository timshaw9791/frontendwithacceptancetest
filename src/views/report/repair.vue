            ...
            <div  slot="slot2" class="safety-body-top">
                ...
                <div style="width:95%">
                    <define-table v-if="show=='All'" :pageInfo="paginator" @changePage="changePage" :data="equipArg" height="3.6042rem" >
                        ...
                        <define-column label="维修数"  field="inHouseCount"></define-column>
                        <define-column label="维修率" field="totalPrice"></define-column>
                    </define-table>
                    ...
                    <define-table v-if="show=='category'" :pageInfo="paginator" @changePage="changePage" :data="equipArg" height="3.6042rem" >
                        ...
                        <define-column label="维修数" field="totalPrice"></define-column>
                        <define-column label="维修率" field="totalPrice"></define-column>
    ...
    export default {
        ...
        methods: {
            ...
            clickNode(data) {
                ...
                if(this.show=="genres"){
                    findEquipRepairStatistics({categorys:3,id:data.data.id,level:'GENRE'}).then(res=>{
                        this.equipArg = res
                        this.paginator.totalPages = res.totalPages;
                        this.paginator.totalElements = res.totalElements;
                    })
                }else if(this.show=="All"){
                    findEquipRepairStatistics({level:'ALL'}).then(res=>{
                        this.equipArg = res
                        this.paginator.totalPages = res.totalPages;
                        this.paginator.totalElements = res.totalElements;
                    })

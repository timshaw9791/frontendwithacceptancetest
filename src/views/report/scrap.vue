<template>
    <div class="scrap_box">
        <div class="scrap_head" data-test="title_box">
            {{$route.meta.title}}
        </div>
            ...
            <report_table ref="table" :table="table">
                <div class="table_header_box" v-if="table.tableType!=='All'&&table.tableType!==''&&computeTotal.count!==undefined">
                    <div class="table_header">
                        ...
                        <div class="table_header_item"><span v-text="`报废件数：${computeTotal.count}`"></span></div>
                    </div>
                </div>
            </report_table>
        </div>
...
<script>
    ...
    import {scrapStatistic} from 'api/report'
    import {
        categoryFindAll,
        deleteGenreById,
        findAllCategoryById,
    ...
    export default {
        ...
        methods: {
            ...
            getAmountList() {
                scrapStatistic(this.table.params).then(res => {
            ...
            computeFunction(data){
                ...
                this.table.info=`装备总数：${totalCount}装备总价(元)：${totalPrice}报废数量：${count}`;
                this.computeTotal={
            ...
            //         this.$refs.scrapTable.resultCheckBox();
            //     }
            // },

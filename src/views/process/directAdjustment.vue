    ...
    export default {
        ...
        methods:{
            ...
            toSee(data){
               ...
               this.downloadSrc='http://192.168.125.117:8080/warehouse/transfers/up-to-down/export-excel'+'?transferOrderId='+this.directDefault.id;
               this.viewStatus.flag=!this.viewStatus.flag
            },
            addDirectAdjustment(){
            ...
            transferClick(){
                let url='http://192.168.125.117:8080/warehouse/transfers/up-to-down/export-excel'+'?transferOrderId='+this.directDefault.id;
                request({
                    method:'post',
                    url:url
                }).then(res=>{
            ...
            submit(data){
                ...
                let url = 'http://192.168.125.117:8080/warehouse/transfers/up-to-down';
                request({
                    method:'post',
                    url:url,
                    data:dataSubmit
            ...
            getUnitAndHouse(){
             ...
             let url='http://192.168.125.117:8080/warehouse/house';
                request({
                    method:'get',
                    url:url,
                }).then(res=>{

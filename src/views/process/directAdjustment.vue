<template>
    <div class="secondment-box">
        <my-header :title="'直调流程'" :searchFlag="false" :haveBlack="!viewStatus.flag" @h_black="black"></my-header>
        <!--<bills></bills>-->
        <div v-show="viewStatus.flag">
            <div class="single-box">
                <div class="single-box-item">
                    <span v-text="'直调申请单'" @click="clickSingle('apply')"></span>
            ...
            <div class="action-box">
                ...
                <div style="margin-left: 38px;cursor: pointer" @click="addDirectAdjustment" v-if="viewStatus.singleFlag.apply">
                    ...
                    <span style="color: #2F2F76">申请直调</span>
                </div>
            ...
            return{
                ...
                urlObject:{
                    transferUrlObj:{
                        ...
                        billUrl:'/direct-transfer-orders/by-user-and-order-state',
                        urlParamsKey:{
                            processDefinitionKey:'direct_transfer',

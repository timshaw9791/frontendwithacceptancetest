        ...
        <div class="apply-process" v-if="show">
            ...
            <div class="apply-process-body">
                <div class="process-info">
                    ...
                    <define-input label="申请人员" v-model="order.applicant" :disabled="true"></define-input>
                    <define-input label="入库机构" v-model="order.inboundOrganUnit" :disabled="true"></define-input>
                    <define-input label="入库库房" v-model="order.inboundOrganUnit" :disabled="true"></define-input>
                </div>
                <div class="process-info">
                    <define-input label="入库人员" :disabled="true" placeholder="-"></define-input>
                    ...
                    <define-input label="出库库房" :disabled="true" ></define-input>
                    <define-input label="出库人员" :disabled="true" ></define-input>
                </div>
                <div class="process-info">
    ...
    export default {
        ...
        methods: {
            ...
            submit() {
                ...
                order.equips = _.filter(_.flatten(_.map(this.order.equips, obj => Object.assign({count: obj.count}, _.pick(obj, 'equipArg')))), function (a) {
                    return a.count != 0
                });

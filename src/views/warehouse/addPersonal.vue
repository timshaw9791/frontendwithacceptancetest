    ...
    <view-container>
        <div style="display:block;width:100%;height:500px">
            <div class="addpersonnelist">
                <entity-input label="机构单位" margin="15px 0 0 0" :disabled="true" v-model="organUnit" format="{name}"
                              :column="12" :options="{search:'organUnits'}" placeholder="请选择"></entity-input>
                <define-input label="警号" margin="15px 0 0 0" :required="true" v-model="order.policeSign"
                ...
                <define-input label="联系方式" margin="15px 0 0 0" :required="true" type="Phone" v-model="order.phone"
                              :column="12"></define-input>
                <define-input label="身份证号" margin="15px 0 0 0" :required="true" type="CardId" v-model="order.idNumber"
                              :column="12"></define-input>
                <define-input label="密码" margin="15px 0 0 0" pattern="password" :required="true"
                              v-model="order.password" :column="12"></define-input>
                <define-input label="指纹信息" margin="15px 0 0 0" placeholder="无" :disabled="true"
                              :column="12"></define-input>
            </div>
            <div class="addpersonnelist">
